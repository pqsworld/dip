...
int GFPLoadImage(const char filename[], unsigned char *ucImage, int *h, int *w)    // filename[] : "./test/0000.bmp"
{
    int i;
	char str[50] = {0};
    int ImgSize = 0;
...
static int Load_Img(const char filename[], unsigned char *ucImg)
{
    ...
    fopen_s(&fp, filename,"rb");//二进制文件的打开用rb
